...
<style>
	...
	.main-content{
		...
		height: 40%;
		margin: 10px auto;
		background-image: url("images/sign22.png");
...
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Login to BoroBijwng</strong></h3>
			</div>
			<div class="l-part">
				<form action="" method="post">
					...
					<a style="text-decoration: none;float: right;color: black;" data-toggle="tooltip" title="Create Account!" href="signup.php">Don't have an account?</a><br><br>
